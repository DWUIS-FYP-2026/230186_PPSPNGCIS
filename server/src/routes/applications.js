...
const FORM1_EDIT_ROLES = new Set(['CS Parole Clerk', 'CS Parole Clerk', 'System Administrator', 'Admin']);
const SUPERVISOR_ROLES = new Set(['CS Parole Clerk', 'System Administrator', 'Admin']);
