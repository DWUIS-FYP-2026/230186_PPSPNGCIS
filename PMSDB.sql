-- NOTE: This file uses MySQL syntax and is superseded by PMSDB_SqlServer.sql for SQL Server.
-- Use PMSDB_SqlServer.sql with ASP.NET Core + Entity Framework Core.
